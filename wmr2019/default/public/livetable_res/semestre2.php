...
<div style="width: 100%; text-align: center;">
                    ...
                    <table class= "table table-striped table-bordered table-hover">
...

                        {
                        	...
                        	$query = mysql_query("SELECT * from n1 where cursos_grado='$curso' AND asignaturas_nombre LIKE '$asign' ORDER BY alumnos_nombre ASC");
...

							{
								...
								echo'<tr class="'.$class.'">
									...
									<td class="xedit" id="'.$fetch['id'].'" key="valor2">'.$fetch['valor2'].'</td>
                    ...
                    <div style="width: 100%; text-align: center;">
                    <p><br><input type="button" value="Volver a Registrar Nota" name="Back2" onclick="history.back()" />
                    <a href="http://www.wmr.skn1.com/sistema/index"><button>Inicio</button></a>
                    </p>
                    </div>
        </div>
