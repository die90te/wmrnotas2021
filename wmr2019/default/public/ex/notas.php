...

{
			...
			echo '<div id="datagrid"  style="font-size:12px; margin-left: 1cm;">
	...
	"<input type='hidden' size='2' value='$n10' name='$ntn10' id='$ntn10' >";
									...
									if ($resultado) 
									{
										...
										{	
											echo "<tr cellspacing='0px'>";
													 //echo "<td>ASIGNATURAS</td>";
													echo "<td width='10%' cellspacing='0px'>PROM.</td>";
													echo "</tr>"; 
											$a=1;
    										while ($row = $resultado->fetch_assoc()) 
    										{     
			...
			echo '<div id="datagrid"  style="font-size:20px;">
				...
				<table border="0" width="90%" cellspacing="0px" align="center">';

				 echo "<tr>";

				 echo "<td align='right'>Promedio 1° Semestre:  

				 
				 <input readonly='true' type='text' height='20px' name='pfinal1s' id='pfinal1s' 
